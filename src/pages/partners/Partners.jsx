...
{
  logo: "/assets/partners/starTech.jpg",
  name: "Star Tech",
  tagline: "Title Sponsor of Mind The Hack 2.0",
  description:
    "Star Tech is one of Bangladesh’s largest technology retailers, providing laptops, desktops, components, and gadgets from global brands. Founded in 2007, it operates multiple outlets and an e-commerce platform serving customers nationwide.",
},
{
  logo: "/assets/partners/EAC.jpg",
  name: "EAC",
  tagline: "Study Abroad Sponsor of Mind The Hack 2.0",
  description:
    "EAC (Education Advisory Centre) is a leading study-abroad consultancy in Bangladesh. It helps students pursue higher education in countries like the UK, Canada, Australia, and Europe through expert guidance and university partnerships.",
},
{
  logo: "/assets/partners/Lexicon.jpg",
  name: "Lexicon – British Council",
  tagline: "Language Development Sponsor of Mind The Hack 2.0",
  description:
    "Lexicon, in collaboration with the British Council, supports English language learning and international exam preparation. It focuses on improving communication skills, academic English, and global learning opportunities for students.",
},
  ...
  const mediaPartners = [
    ...
    {
  logo: "/assets/partners/KUJA.jpg",
  name: "Khulna University Journalism Association",
  tagline: "Media Partner",
  description:
    "Khulna University Journalism Association (KUJA) is a student organization dedicated to promoting journalism, media practices, and campus news coverage at Khulna University.",
},
{
  logo: "/assets/partners/tbs-graduates.png",
  name: "TBS Graduates",
  tagline: "Media Partner",
  description:
    "TBS Graduates is a career-focused platform by The Business Standard that shares opportunities, insights, and stories relevant to university students and fresh graduates.",
},
{
  logo: "/assets/partners/the-business-standard.png",
  name: "The Business Standard",
  tagline: "Media Partner",
  description:
    "The Business Standard is one of Bangladesh’s leading English-language business news platforms, covering economy, technology, education, and national developments.",
},
{
  logo: "/assets/partners/the-daily-campus.png",
  name: "The Daily Campus",
  tagline: "Media Partner",
  description:
    "The Daily Campus is a popular online news portal in Bangladesh that focuses on university news, student activities, education updates, and youth-related stories.",
},
...
{
  logo: "/assets/partners/capture-crew.png",
  name: "Capture Crew",
  tagline: "Photography Partner",
  description:
    "Capture Crew is a creative photography team specializing in event coverage, capturing memorable moments with professional quality and artistic storytelling.",
},
{
  logo: "/assets/partners/canvas.png",
  name: "Canvas",
  tagline: "Photography Partner",
  description:
    "Canvas is a photography and visual storytelling team focused on capturing vibrant campus events, delivering high-quality photos that preserve every memorable moment.",
},
