...
import styles from "/src/styles/TextAnimation.module.css";



const DynamicContent = () => {
  const texts = [
    "Over 700+ members and 90+ speakers are in this family",
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-black opacity-50 blur-sm"></div>
        ...
        <div className="absolute top-[calc(25%-150px)] left-1/2 transform -translate-x-1/2 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-blue-300 to-blue-100 text-l sm:text-2xl md:text-4xl lg:text-5xl font-extrabold tracking-wide shadow-lg animate-pulse whitespace-nowrap">
